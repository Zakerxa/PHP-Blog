        ...
        <div class="col-11 shadow card col-md-8 col-lg-4 text-center pt-4 pb-4" style="border-radius: 20px;">
         <h4 class="font-weight-bold pb-3">LogIn</h4>
          ...
          <form action="" method="POST" class="row justify-content-center">
             <input name="token" type="hidden" value="<?=$_SESSION['token'];?>">
               ...
               <li class="col-10 list-unstyled mt-2 pt-3 pb-3">
                <div class="text-center">
                  <button name="login-btn"  class="btn btn-dark border-0 pt-2 pb-2 w-100 shadow font-weight-bold text-light">LogIn</button>
                </div>
               </li>
           ...
           <p class="pt-2">Don't have an Account? <a href="register.php" class="text-success font-weight-bold">Register</a></p>
