<?php
 ...
 if(isset($_POST['add-cat'])){
    ...
    if(empty($category)){
        echo "<script>alert('Insert Something');window.location.href='catadd.php';</script>";
        exit();
    }else{
         ...
         <form action="" method="POST" class="row mb-5 justify-content-center">
             <div class="col-12 pb-3">
              ...
              <div class="input-group mb-2 col-12 col-md-8 col-lg-7 ">
                <input type="text" name="category" class="form-control w-25 border-0 pl-2"  placeholder="Category Name" style="border-top-left-radius:12px;border-bottom-left-radius:12px;outline:none;" aria-label="name" required>
